...
This section describes how to create a data migration task through the Explorer interface to migrate data from TDengine 2.x, which is frequently used for applications like Edge-Cloud Synchronization, to the current cluster.
